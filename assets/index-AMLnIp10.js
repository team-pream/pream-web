...
`,be=o`
  ...
  flex: 1;
  ${e.typo.body2};
`,ve=h.forwardRef(({name:r,...a},i)=>s("div",{css:ye,children:[t("input",{ref:i,id:r,name:r,css:be,...a}),t(A,{width:"20px",height:"20px",cursor:"pointer"})]}));ve.__docgenInfo={description:"",methods:[],displayName:"SearchBar",props:{name:{required:!1,tsType:{name:"string"},description:""}},composes:["InputHTMLAttributes"]};export{E as A,y as B,Q as C,ee as D,ae as F,le as G,he as I,xe as R,O as S,H as a,ve as b,_ as c,A as d,G as e};
