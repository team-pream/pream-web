...
`,be=o`
  ...
  flex: 1;
  ${e.typo.body2};
`,ve=h.forwardRef(({name:r,onClick:a,...i},n)=>s("div",{css:ye,children:[t("input",{ref:n,id:r,name:r,css:be,...i}),t(A,{width:"20px",height:"20px",cursor:"pointer",onClick:a})]}));ve.__docgenInfo={description:"",methods:[],displayName:"SearchBar",props:{name:{required:!1,tsType:{name:"string"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}},composes:["InputHTMLAttributes"]};export{H as A,y as B,Q as C,ee as D,ae as F,le as G,he as I,xe as R,O as S,ve as a,_ as b,A as c,G as d,E as e};
