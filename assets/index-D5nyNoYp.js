import{j as l,t as c,c as n,a as o,b as m}from"./theme-BvZHPoXC.js";import{r as p}from"./index-CTjT7uj6.js";function u({color:e,typo:s,children:r,...t}){return l("span",{style:{color:e},css:{...c[s]},...t,children:r})}u.__docgenInfo={description:"",methods:[],displayName:"Text",props:{color:{required:!1,tsType:{name:"string"},description:""},typo:{required:!0,tsType:{name:"unknown"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}},composes:["HTMLAttributes"]};const g=({wrap:e})=>n`
  display: flex;
  gap: 8px;
